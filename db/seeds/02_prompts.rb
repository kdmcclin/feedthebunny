Prompt.create!([
  ...
  {text: "No wonder you're the football coach.  DAMN you're fit."},
  {text: "You're so wrong I'm going to stop my lecture to tell you why."},
  {text: "Coaches who aggressively argue for whose team is better even though they're completely different sports."},
  {text: "Our students think we're dating."},
  {text: "A student catches us texting to each other in class.  Oh how the tables have turned."},
  {text: "We leave each other notes on the whiteboards."},
  {text: "Our classrooms are adjacent to each other and we can always see each other through the door windows."},
  {text: "I will yell at you even though both our doors are closed to shut up your class jesus christ."},
  {text: "Our students see us leave the same car in the morning and guess what they think."},
  {text: "I'm the drama teacher and you're the only who can actually act.  Help me demonstrate this love scene to my students."},
  {text: "I cut myself really badly in Printmaking and I'm trying not to bleed everywhere.  Turns out you carry a bunch of first aid supplies in your bag."},
  {text: "I let you have a few sheets of darkroom photo paper, to pay me back you offered to model privately for my Studio Photography assignment."},
  {text: "I'm a traditional painter who has to take a basic Photoshop class.  You're a graphic design major sitting next to me and getting sucked into helping me out because I'm so terrible at this."},
  {text: "My pottery bowl exploded in the kiln and I feel like a failure.  You found me crying about it in the hallway."},
  {text: "Our Figure Drawing teacher is an asshole.  You stuck up for me when he started railing on my portraits."},
  {text: "You saw me struggling to carry a giant cardboard sculpture for my installation and helped me get it to class."},
  {text: "I'm zoning out working on this painting and you just stopped me from drinking out of my dirty water cup."},
  {text: "A mutual friend of ours has this whole vision for their Black and White Photography final and we volunteered to be their models without knowing how sexual this shoot would turn out."},
  {text: "Person B is an immortal and lived 300 years. Person A is a kid and was trapped in snow, and Person B found them and helped. Ten years later, Person A and B re-meet."},
  {text: "This is totally awkward considering before this the only interactions we've ever had have been casual nods to each other in the hallway but there's a huge fucking spider in my bath tub and you seem like the friendly neighbor type please help me."},
  {text: "You're the only delivery person who gets to my house in any semblance of the word fast which is why I keep requesting you but you don't believe me and tease me constantly about it."},
  {text: "Okay I get it you're a great thief and don't want to go to jail but I'm the exhausted as fuck detective that's assigned to catch you.  I swear to God if you let me bring you in so I can sleep I'll get you a good deal."},
  {text: "My parents moved me halfway across the world when we were twelve and before that we were best friends but now I'm back and moving in across the hall from you so hi?"},
  {text: "I've been travelling a lot and somehow you're in every single city I go to.  Seriously what the fuck?  Who even are you and how are you doing this?"},
  {text: "Not going to lie, I thought you were the weak one of this friend group but your whole life just went to complete shit around you and somehow you're still acting the same so if you want to be weak you can be around me."},
  {text: "It seems weere the only two people in this class that actually know what the fuck is going on.  Want to team up for this project and ruin everybody's lives?"},
  {text: "We started arguing about which Hogwarts house this one character would be in and we completely lost track of time and now you're demanding I take you out to dinner.  Is this a date?"},
  {text: "I came to check out this support group but things have kind of been majorly sucking lately and you were there and I didn't even know anything was wrong but we've known each other for months.  What gives?"},
  {text: "I meant to text the contact one above you in my phone's contact list for a booty call but I didn't realize I hit your name until I sent it so now I'm just sitting here feeling those little three dots hardcore judging me."},
  {text: "It's the middle of the night and I'm walking home alone in the dark and there's this guy following me and he's starting to gain on me and I found this phone booth with a lock on the door and I tried to call my best friend but my hands were shaking so badly I accidentally dialed the wrong number and I don't even know you but help me."},
  {text: "You're nonbinary and I didn't know what that meant until you explained it, but now I think I'm nonbinary too."},
  {text: "You're sitting in the booth I always sit in but you refuse to leave and I refuse to let you have it so we end up sharing a booth."},
  {text: "Hi, sorry, I live below you and I hear your dog running around and barking all the time and--no, no it's fine I was just hoping maybe I could pet it?"},
  {text: "I put salt in your coffee when you were in the bathroom and you drank it all.  That was hardcore."},
  {text: "Sorry but this is the silent floor of the library and if you don't shut up so I can study I will yell at you and get us both kicked out."},
  {text: "Yeah yeah I'm the person who tripped and fell on their face to get to the podium on stage for the welcome speech at freshmen orientation."},
  {text: "You live across the courtyard from me and saw me dancing and singing enthuisiastically to my collection of 90s pop and Disney music and now you can't look me in the eye without laughing."},
  {text: "You just watched me slip on the ice and wind up sitting in the snowbank beside the parking lot.  You're laughing and now it's you slipping and your face in the snowbank across from me."},
  {text: "I died and now I'm a motherfucking ghost but instead of being depressed I decide to start haunting people for the hell of it by doing stupid shit like drawing penises on peoples faces while their asleep and replacing their Oreo cream with toothpaste and you end being the only one that can see me."},
  {text: "I'm a motherfucking genie and you rubbed my lamp so congratulations you get three wishes but as it turns out you can't think of anything you want so I'm basically stuck with you until you do and you seem hell bent on taking your fucking time……great."},
  {text: "I was a little shithead in heaven and as a punishment I now have to be your guardian angel and even though you're cute as fuck I still fucking hate it."},
  {text: "I decided to take a shortcut home that involves crawling through a really tight hole in a fence and I end up getting stuck and you just happen to pass by and after poking fun at me for a million years you finally decide to try and help me."},
  {text: "We're at a club and although you're a really shitty dancer you're also really fucking adorable so I decide to say hi and you end up accidentally hitting me in the face and fucking hell I think you broke my nose."},
  {text: "You come into my 24hr diner at the oddest times because of your weird job but you keep forgetting that we talk because you're always sleep deprived."},
  {text: "My neighbour keeps ordering weird shit but they dont want to face the mailperson's judgement so they keep using my address instead."},
  {text: "Escaped to the laundry room to avoid hearing my room-mates having extremely loud sex only to find you're here doing the same thing."},
  {text: "You were trash talking my favourite character in the cinemas and obviously I need to show you the light, even if I have to buy you a burger to get you to listen."},
  {text: "Our mutual friend dropped out of this trip at the last minute, so hi I guess we’re spending the next two weeks together."},
  {text: "You forgot to remove your snarky sticky note comments in this textbook and since I got kicked out of the library for laughing too loudly, I'm going to reply to each and every one."},
  {text: "Since there's only one can of energy drink left in the store, which we both need to survive the disgustingly boring lecture we just discovered we both have, how about we share it."},
  {text: "We're on a road trip and hell no you cannot survive off of gas station candy I’m taking us to a real restaurant."},
  {text: "On a road trip going to tourist traps just to buy shitty souvenirs for each other and compete for the most tacky ones."},
  ...
  {text: "Exams are coming up and I bake when I'm stressed PLEASE TAKE MY BROWNIES I HAVE 12 TRAYS SITTING AT HOME."},
  {text: "This is not l'abc café, you are not les amis, please stop planning your doomed French revolution in my goddamn coffee shop."},
  {text: "I'm a barista and the regulars somehow found out it was my birthday and did a flashmob a cappella version of my favourite song I'm crying."},
  {text: "We met in an anonymous chatroom on a day we were both bored and now we are chatting everyday and I think I am in trouble."},
  {text: "You are the super cute barkeep in the club I always party at with my girls and you always wink at me and make my knees go weak but I don't know if it's just me or if you wink at everybody."},
  {text: "We both visited this seminar at university and smashed all the other students with our intersectional feminism talks and I think we should have coffee and fight the patriarchy together."},
  {text: "I am a tattoo artist and you keep coming into our studio but always change your mind at the last minute and me and my colleagues are betting on whether or not you have the guts to finally get a tattoo one day."},
  {text: "We work at the same office and one day you used my tea mug and left a sticky note to it saying thanks and now we are talking via sticky notes and I don't even know who you are but you seem to be a real cutiepie."},
  {text: "I went running through the forest with my dog and found you hugging a tree and it was so cute that I had to take a picture and upload it to Instagram and two days later you wrote me a message and now we have a treehugging date in the forest."},
  {text: "We meet on a convention and you are dressed as the other half of my OTP and now we are kissing for a picture and I think I am in heaven."},
  {text: "You are my sister's chemistry tutor and I sometimes sit down in the living room with a book so that I can watch you in secret and my sister always rolls her eyes at me but I just can't help my ridiculous crush on you."},
  {text: "I am looking for a new flatmate and I am not going to lie you won the competition because of your extensive knowledge about the Star Trek universe, your bad puns, and your impressive cleavage."},
  {text: "I hate commitment but my dad's dying wish is to see me get married and you're an old family friend I ran into at the airport on my way to visit him so hey let's get engaged."},
  {text: "We're only engaged to get our parents off our backs and you're in love with somebody else so feel free to hook up with them idc I'm not jealous (yes I am)."},
  {text: "We were both drunk when you proposed to me and I accidentally posted about it across social media so now we're hungover and trying to figure out this mess because we're not even dating."},
  {text: "You thought I'd been staring at you all night and wanted you to come over, but really I'm just blind and was looking nowhere. At least your voice is pretty."},
  {text: "Nobody cleared the snow off the already not up-to-code ramp, and your wheelchair flipped as you tried to go up. I came to help you but I've slipped too and now we're both on the ground."},
  {text: "I spilled an entire hot cup of coffee all over you I'm so sorry I have MS and my hands aren't cooperating today. (I'm helping wipe you down and gosh you're cute)."},
  {text: "You're the only other Deaf person at this university, and I don't particularly like you. But you're the only one who can talk smack with me in ASL so I guess we can be study partners."},
  {text: "The store kicked me out after saying that my psychiatric support dog wasn't a real service dog so you bought the tea I was trying to get and rushed out after me to make sure I got it."},
  {text: "I'm an amputee, and when I was getting out of my car I got yelled at by a guy for using the handicap spot so I took off my prosthetic leg and threw it at him. You watched this happen and are laughing so hard you had to use your inhaler."},
  {text: "I have a chronic illness and have to work from home when I have a flare up/feel especially ill. You're the one our boss always send to deliver me my work."},
  {text: "I have Cystic Fibrosis and you take the same bus as me everyday. I don't know your name but you always have tissues to hand me with only smile when I have a coughing spell."},
  {text: "Your electric wheelchair ran out of battery in the middle of the side walk and now I'm trying to use my manual chair to help pull you to the nearest repair shop."},
  {text: "The office of accessibility paired us up saying that we would make good friends but I've never met you before and I already think you’re annoying."},
  {text: "I'm a defense attorney who has dwarfism and you're the prosecutor I often go up against. We're in court when the judge starts using infantilizing language and you pause the judge's opening statements to complain about how many cases you've lost to me."},
  {text: "We're roommates at the hospital and you won't shut up. I'm trying to get some sleep over here."},
  {text: "I'm in a manual wheelchair and my arms are exhausted so you offered to tie a rope to me and pull me like a sled dog with your electric wheelchair."},
  {text: "We're in the same class and it has a killer attendance policy but we're both in the hospital a lot so when one of us can't go the other Skypes them in."},
  {text: "We're both Deaf and you can hear some low tones and I can hear some high tones so we've decided to interpret what the other can't hear. It kinda works."},
  {text: "Our university's services for students with disabilities office has stairs leading up to it and our professors won't give us the accommodations we need without a letter from them. Wanna camp out in front of the Dean's office with me?"},
  {text: "I'm Deaf and you’re blind and our professor thought we should be partners for this project for some reason, and there are several easier ways to get around this but instead we're learning tactile sign instead of working on this ppt presentation."},
  {text: "We're both Deaf and the group we're in is refusing to do anything as basic as not cover their mouths when they talk so we've abandoned them."},
  {text: "Some asshole on the train isn't getting out of the wheelchair space for you so I threw my cane at him."},
  {text: "I hate you and everything you stand for but you're also the only other physically disabled person on campus so I guess we're friends now."},
  {text: "I'm on the bus and my 2-year-old won't stop crying, except you just smiled at them and they did."},
  {text: "I asked you to babysit one time and now my child keeps asking when you will spend time with them again."},
  {text: "You asked me to the store with you and your child, and now my distant relative we met thinks I'm married with a baby."},
  {text: "We are friends and my child's first word was your name and I'm jealous but also kind of endeared."},
  {text: "You've been sleeping at mine because your house is being renovated and we aren't even dating, yet every time you wake up to the baby crying and sigh, 'I'll go' I feel like we might as well be married."},
  {text: "Our children are in the same class and we both hate their teacher, eventually the parents' evenings are just us competing who can call out snarkier comments."},
  {text: "You crouched down to coo at my baby but I forgot to tell you their favorite thing to do is to play with people's hair and now they won't let go of you."},
  ...
  {text: "You just busted into my house asking for help in bad English and I thought you were a tourist who ran into some trouble at comic con or somethiing judging by your costume but you’re actually an alien who crashed near and are being sought by your planet’s authorities"},
  {text: "Now that I think about it I never asked why is your house built around a giant-ass tree please explain"},
  {text: "We had a sleepover and I woke up earlier than you so I wanted to grab something to eat and why the actual fuck are there so many blood packs in there"},
  {text: "You’ve been avoiding eveyone for a couple days and I noticed your arm seemed paralyzed or something and I wanted to talk to you except when I grabbed said arm to stop you from running away it came out oops"},
  {text: "We were dicking around in chemistry but you accidentally received some of whatever we made and it turns out that this substance strongly weakens you/forces you to take your true form"},
  {text: "You had an accident and I thought you were dead because I couldn’t hear your heartbeat but you turned out just fine"},
  {text: "A dragon drops in for the opening day celebration of a new local health food store"},
  {text: "Bored high school wizards decide to throw a party to celebrate tomorrow’s graduation. Nothing could possibly go wrong."},
  {text: "Weddings are stressful. They’re especially tricky when one family is magical and the other hates spells, and both mothers want to control the celebration."},
  {text: "There’s a snail orchestra. They decide to put on a concert for the gardener who has (unwittingly) fed them for years."},
  {text: "A witch living secretly in suburbia casts a spell to speed up the laundry, but it backfires—just in time for trick-or-treaters to deal with dancing underwear"},
  {text: "A fed-up genie, sick of being over-sexualized and paid in wishes, throws a magical tantrum which turns everyone in the world into another gender."},
  {text: "One bright morning in May, all domestic pets start talking."},
  {text: "Tinnitus is actually the result of pissed-off pixies, who haven’t been properly fed in a couple of centuries (hint: it involves sugar and rum)."},
  {text: "What would you do if every tree you passed began whispering your name?"},
  {text: "Mermaids attempt to install a democratic form of government, but the cephalopods are causing trouble."},
  {text: "A young Fey prince runs away from responsibility to start a career as a street musician."},
  {text: "She’s a cop. He’s the owner of a jewelry store. A sudden rash of break-ins brings her to his store over and over and over again, until it becomes obvious that he might be tripping the alarm on purpose—just to see her. That’s illegal—but she’s kind of falling for him, too."},
  {text: "Aliens who only communicate with sign language invade. To avoid war, our governments must engage a vastly marginalized portion of the human population: the hearing-impaired."},
  {text: "A family receives a gift from a far-away aunt for Hanukkah, but wake up the next morning to find a golem has formed from the packing materials."},
  {text: "While hiking in the woods, a man and his partner come across a reindeer that seems to desperately want to be followed."},
  {text: "'I found it, on a branch, in the Christmas tree.'"},
  {text: "A Christmas Tree that loses its star sets out on a mission to find it."},
  {text: "Two elves decide to stow-away inside a Christmas package bound for a young boy in rural Pennsylvania."},
  {text: "When a blizzard strands several people in an abandoned factory in Northern California, they find the factory’s workers — elves — never really left."},
  {text: "It came upon a midnight clear. But it wasn’t what I expected."},
  {text: "It’s your first day on the job, as one of Santa’s elves."},
  {text: "A man with a collection of dreidels buys a new one from an antique shop on Second Avenue. But when he gives it its first spin, it doesn’t stop."},
  {text: "It was the night before Christmas, and suddenly all the creatures were stirring."},
  {text: "Driving through the country one night, you spot a lone Christmas tree trimmed and lit, but you have no idea who decorated it or where it’s getting its power."},
  {text: "After bringing your newborn baby home from the hospital, you get a visit from three men who claim to have travelled a long way to see your child. Oh, and they have gifts."},
  {text: "If you put that needle in my arm, you’ll be losing much more than your medical license, my friend"},
  {text: "I’m not leaving this waiting room until I know EXACTLY where you purchased that piece of art hanging on the wall - it calms my partner"},
  {text: "I am a surgeon, but I cannot perform under these conditions - not with who’s on the table right now"},
  {text: "I’ve cut my hair short for hygienic purposes but now all the elderly patients are asking me if I’m going through a phase or if I’m gay"},
  {text: "You wake up in the hospital with a splitting headache and an awareness of only two things. 1) you have a concussion and 2) you are in the middle of a superhero origin story. Problem is, it’s your origin story and you don’t remember a thing."},
  {text: "You open your eyes to a hospital room full of people you don’t recognize. You’ve just been informed that you’re 10 years old and you’ve been in a coma. The life you lived was a dream. All 20 years of it."},
  {text: "In a world where superheroes exist, why did we have to get stuck with this one?"},
  {text: "In a world surrounded by superheroes and villains, he was a pacifist living in a small town in rural Pennsylvania. He was very religious and didn't often leave his tiny hamlet, but a work-related matter put him in Philadelphia for a conference. During an evening stroll back to his hotel, he was attacked by two crooks with weapons. When he put up his hands to defend himself, a large blast of fire and energy shot out, blowing the crooks backward at an alarming speed and causing them to die almost instantly. After news got out that he was one of the most powerful super beings on the planet, the public clamored for him to don a cape."},
  {text: "In school she had the nickname of Plain Jane and when she realized she had the ability to fly, the nickname took on multiple meanings."},
  {text: "She was so upset that her boyfriend left her for the hottest girl in school that she wished to be that girl. In a few moments, she transformed into the girl and knew that she could shape shift. She used the powers for petty pleasures in high school and college but knew there had to be a bigger purpose."},
  {text: "You know the phrase 'what doesn't kill you makes you stronger?'' Well, for her, it's the truth. When she broke her leg in middle school, she noticed that it not only grew back stronger, but she was now able to jump over five feet vertically on it. Small cuts would heal back with a second skin that was practically invulnerable."},
  {text: "But that's not even me in that tabloid!"},
  {text: "No I wasn't abducted by aliens. I said CANADIANS, not aliens."},
  {text: "A superhero stains their clothes at school/work and the only other set of clothes they have available is their superhero costume"},
  {text: "The world assumes there’s only one of them. Only one superhero"},
  {text: "Only one of the twins is a costumed hero. The other borrows their superhero identity."},
  {text: "Superhero twins who have strangely incompatible powers."},
  {text: "A superhero tries to get himself classified as a natural disaster so people can get refunded by their insurance company when he destroys their home during a fight."},
  {text: "Every intelligent, skilled or rich human has been evacuated from the Earth to avoid the alien invasion. This leaves the dregs, criminals and the poor behind on Earth to fend for themselves. Centuries later, the other return to 'liberate' Earth only to find that they have won and prospered."},
  {text: "Alien scientists are watching earth and they are embarassed that our technology is so bad. They want to help us, but without us noticing."},
  {text: "A person has spent the last 10 years on death row and vigorously defended their innocence to no success. They have no memory of the day of the crime. On the way to their execution they stumble and hit their head, causing the entirety of their memory to return."},
  {text: "Aliens visit Earth, in search of an intense narcotic for their species: sodium chloride. To their shock, salt is so common on Earth that the planet becomes a haven for alien junkies and addicts."},
  {text: "A doctor from the year 2217 gets thrown back in time to 2016. She tries to make the best of it, but the world of the past is grim, the people are savage, and the medical practices are downright medieval."},
  {text: "Your grandfather always claimed that he was abducted and fought in an alien war for a few years before returning to Earth. Now, at his funeral, you see several otherworldly strangers paying their final respects."},
  {text: "My jaw dropped when a tiny voice at the edge of my beach shovel said, 'Don’t hurt me!'"},
  {text: "You sneak me out of the castle sometimes to do fun things like play on the beach or ride horses."},
  {text: "I went to a forest to bury a body but somebody was already there burying one."},
  {text: "You were chased by cops and took me as a hostage and now we’re spending the night in a dusty barn"},
  {text: "You were chased by cops and took me as a hostage but you didn’t realized the cops were after me too."},
  {text: "You’re a cop and you got called to a crime scene to arrest a criminal but you realize the criminal is the person you’re dating"},
  {text: "An immortal who doesn’t shy away from photos or paintings"},
  {text: "Person A owns a flower shop and person B comes storming in one day, slaps 20 bucks on the counter and says 'How do I passive-aggressively say fuck you in flower?'"},
  {text: "You tried on a shirt that was too small in the store. I work the changing rooms at and I had to help you out of it and now we’re making small talk"},
  {text: "We were both at this party and you were the designated driver but I was too drunk to give you my address so I woke up in your bed and commented on how you were way out of my league before realizing we didnt sleep together"},
  {text: "I broke your nose in a mosh pit, sorry."},
  {text: "You just punched me in the face while gesturing wildly to a friend, your friend can’t stop laughing and im too shocked to respond to your apologies"},
  {text: "I work at a department store and if you take out and unfold another fucking shirt and just leave it, I’m going to fucking shove it down your throat"}
])
